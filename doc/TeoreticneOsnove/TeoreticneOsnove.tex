...
\begin{figure}[ht]
	\begin{centering}
		...
		\bicaption[fig: odsekStruge]{}{\label{fig:odsekStruge}
			Izbrani odsek struge
			}{Figure}{Chosen part of the river channel}
			\addfiguretolof{Chosen part of the river channel}
